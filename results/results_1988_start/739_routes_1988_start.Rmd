...
all_sims <- readRDS(here::here("analysis", "results", "results_1988_start", "all_sims.RDS"))
all_preds_b <- readRDS(here::here("analysis", "results", "results_1988_start", "all_preds_b.RDS"))
all_aics_b <- readRDS(here::here("analysis", "results", "results_1988_start", "all_aics_b.RDS"))
all_preds_e <- readRDS(here::here("analysis", "results", "results_1988_start", "all_preds_e.RDS"))
all_aics_e <- readRDS(here::here("analysis", "results", "results_1988_start", "all_aics_e.RDS"))
all_cs_compares <- readRDS(here::here("analysis", "results", "results_1988_start", "all_cs_compares.RDS"))
...
```{r render biomass and energy histograms, fig.dim = c(6,5)}
